export default function LoginButton({ alert }) {
  return (
    <button className="inline-flex items-center justify-center w-full gap-2 mt-2 font-bold text-center bg-white my-button group hover:bg-black hover:text-white h-11 rounded-xl ">
      {alert.status ? (
